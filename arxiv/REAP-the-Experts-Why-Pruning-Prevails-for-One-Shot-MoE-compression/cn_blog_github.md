...
![Figure 3](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/REAP-the-Experts-Why-Pruning-Prevails-for-One-Shot-MoE-compression/fig/combined-all-tasks_qwen_and_glm.png)
> 图解：GLM-4.5-Air 与 Qwen3-30B 在多任务上的压缩效果。50% 压缩时，Merging 在生成类任务上明显下滑，REAP 保持最好稳定性。

## 生成任务分析：Merging 为什么更差
作者进一步统计生成输出分布差异：

![Figure 4](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/REAP-the-Experts-Why-Pruning-Prevails-for-One-Shot-MoE-compression/fig/ngram_diversity.png)
> 图解：N-gram 多样性。Merging 输出显著更重复，REAP 接近原模型。

![Figure 5](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/REAP-the-Experts-Why-Pruning-Prevails-for-One-Shot-MoE-compression/fig/cross_perplexity.png)
> 图解：cross perplexity，Merging 与原模型分布偏离更大。

![Figure 6](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/REAP-the-Experts-Why-Pruning-Prevails-for-One-Shot-MoE-compression/fig/jsd_small.png)
> 图解：logit JSD 随 token 位置变化。Merging 随序列增长快速失配，REAP 更稳。

![Figure 7](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/REAP-the-Experts-Why-Pruning-Prevails-for-One-Shot-MoE-compression/fig/combined_weight_dist.png)
...
![Figure 8](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/REAP-the-Experts-Why-Pruning-Prevails-for-One-Shot-MoE-compression/fig/combined_performance_vs_params.png)
...
![Figure 9](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/REAP-the-Experts-Why-Pruning-Prevails-for-One-Shot-MoE-compression/fig/restricted_cluster_size_m_smoe.png)
> 图解：限制最大 cluster size 后，编码任务准确率大幅下降，说明大簇是性能崩溃来源。

## 校准数据的重要性
生成任务必须用 **领域数据校准**，否则压缩模型可能完全失效。

![Figure 10](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/REAP-the-Experts-Why-Pruning-Prevails-for-One-Shot-MoE-compression/fig/dataset-ablation-all-models.png)
> 图解：用 c4 校准导致 coding 质量崩溃，领域数据明显更稳。

![Figure 11](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/REAP-the-Experts-Why-Pruning-Prevails-for-One-Shot-MoE-compression/fig/bar-combined-dataset-all-tasks-Qwen3-30B-A3B.png)
