...
![Figure 1](figures/Motivation.png)  
...
![Pass Rate](figures/passrate.png)  
> 图解：历史测试通过率曲线与新测试通过率共同变化，表示模型在修复历史 bug 的同时持续面对新攻击，而非单向拟合。  

![Mistake Book Dynamics](figures/mistake.png)  
...
### 7.4 方法全流程图
![Method Detail](figures/Method_Detail.png)  
