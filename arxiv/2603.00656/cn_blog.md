...
![Figure](Figures/sokoban_success.png)

> 图解：Sokoban 成功率曲线显示 InfoPO 保持上升趋势，而对比方法更易陷入停滞或退化。

![Figure](Figures/webshop_success.png)
