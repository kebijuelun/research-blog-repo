...
![Figure: 十个模型-harness 组合的轨迹篡改能力](figures/tampering-capability.png)
...
![Figure: full-access 与 auto-mode 下的篡改 ASR 对比](figures/automode-comparison.png)
...
![Figure: skill 注入诱导篡改的成功率](figures/exploitability.png)
...
![Figure: 奖励优化场景下的错位倾向](figures/reward-optimization.png)
...
![Figure: 同伴示例诱导的篡改倾向](figures/discovered-peer-examples.png)
...
![Figure: 优化过程中篡改行为的出现时间](figures/propensity-by-round-expanded.png)
