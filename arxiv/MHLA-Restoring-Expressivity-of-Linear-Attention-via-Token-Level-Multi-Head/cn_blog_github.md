...
![Figure 1](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/MHLA-Restoring-Expressivity-of-Linear-Attention-via-Token-Level-Multi-Head/figs/mhla_teaser.png)
...
![Figure 2](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/MHLA-Restoring-Expressivity-of-Linear-Attention-via-Token-Level-Multi-Head/figs/rank_sparsity_analysis_v5.png)
> 图解：左图展示不同注意力机制的注意力热力图，线性注意力明显更“平均”，MHLA 更集中。

![Figure 3](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/MHLA-Restoring-Expressivity-of-Linear-Attention-via-Token-Level-Multi-Head/figs/rank_entropy_comparison.png)
...
![Figure 4](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/MHLA-Restoring-Expressivity-of-Linear-Attention-via-Token-Level-Multi-Head/figs/MHLA_Comparison.png)
> 图解：对比传统线性注意力（全局 summary）与 MHLA（block summary + mixing），MHLA 在保持线性复杂度的同时恢复 query-conditioned 的选择性。

![Figure 5](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/MHLA-Restoring-Expressivity-of-Linear-Attention-via-Token-Level-Multi-Head/figs/MHLA.png)
> 图解：MHLA 总体流程图。输入被拆为多个 block，每个 block 计算局部 KV summary，再通过混合系数构建 query-specific summary。

![Figure 6](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/MHLA-Restoring-Expressivity-of-Linear-Attention-via-Token-Level-Multi-Head/figs/Visualization_of_coefficient_matrix_init.png)
...
![Table 1](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/MHLA-Restoring-Expressivity-of-Linear-Attention-via-Token-Level-Multi-Head/figs/MHLA_Comparison.png)
...
![Table 2](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/MHLA-Restoring-Expressivity-of-Linear-Attention-via-Token-Level-Multi-Head/figs/mhla_teaser.png)
> 图解：FID 对比中，MHLA 在 DiT-S/2 和 DiT-XL/2 上均显著优于线性注意力，甚至超过自注意力。

![Figure 7](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/MHLA-Restoring-Expressivity-of-Linear-Attention-via-Token-Level-Multi-Head/figs/loss_comparison_sana_v2.png)
> 图解：SANA 微调中，MHLA 训练损失更快下降且收敛更低，体现更强适配能力。

![Figure 8](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/MHLA-Restoring-Expressivity-of-Linear-Attention-via-Token-Level-Multi-Head/figs/sana-pic2.png)
...
![Figure 9](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/MHLA-Restoring-Expressivity-of-Linear-Attention-via-Token-Level-Multi-Head/figs/loss_comparison_wan.png)
