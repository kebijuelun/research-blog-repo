...
![Per-step MTP acceptance rates during RL](figs/mtp_position_acc_triple.png)
...
![Entropy vs Accept Length](figs/entropy_vs_accept_length.png)
...
![Draft/Target Distribution](figs/draft_target_comparison.png)
...
![Decomposition of acceptance changes](figs/decomposition_delta.png)
...
![CE vs TV accept rate (reasoning/conversation)](figs/ce_vs_tv_accept_rate.png)
...
![CE vs TV accept length (agentic tasks)](figs/swe_vending_accept_length.png)
...
![Target-only accept length](figs/to_ce_tv_accept_length.png)
...
![Accept length during Reasoning RL](figs/rl_hybrid_accept_len.png)

![Accept length during SWE RL](figs/rl_swe_accept_len.png)

![Accept length during SWE RL on Qwen3.7-Max](figs/rl_swe_max_accept_len.png)
...
![Reasoning RL latency](figs/rl_latency.png)

![SWE RL latency](figs/rl_swe_latency.png)

![Agent RL latency](figs/rl_agent_latency.png)
...
![Entropy vs accept length (Reasoning RL)](figs/entropy_vs_accept_len_hybrid.png)

![Entropy vs accept length (SWE RL)](figs/entropy_vs_accept_len_swe.png)

![Entropy vs accept length (SWE RL, Qwen3.7-Max)](figs/entropy_vs_accept_len_swe_max.png)
...
![Accept length with MTP updates](figs/rl_hybrid_mtp_train_accept_len.png)
...
![Accept rate delta vs throughput](figs/accept_delta_vs_throughput.png)
...
![Entropy gap vs KL](figs/entropy_gap_vs_kl.png)

![Entropy gap vs RS accept rate](figs/entropy_gap_vs_rs_accept.png)

![KL vs RS accept rate](figs/kl_vs_rs_accept.png)
...
![MTP metrics during RL](figs/rl_mtp_metrics.png)
...
![Accept length vs temperature](figs/accept_length_vs_temp.png)

![Accept rate vs output length](figs/accept_rate_vs_position.png)
...
![RS decision boundary](figs/rs_decision_boundary.png)
...
![Accept length during Agent RL](figs/agent_accept_len_csv.png)
...
![MTP loss under top-K truncation](figs/mtp_lm_loss_topk.png)
