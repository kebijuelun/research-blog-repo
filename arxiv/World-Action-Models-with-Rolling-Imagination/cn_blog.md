...
![Rolling-WAM 整体示意](figures/rollingwam-teaser.png)
...
![Rolling-WAM 框架](figures/rollingwam-framework.png)
...
![想象与真实 rollout 对比](figures/robotwin-imagined-observed.png)
...
![重规划延迟对比](figures/robotwin_replan_latency.png)
...
![不同窗口大小下的延迟](figures/replan_annotated_latency_trend.png)
...
![G1 真机任务](figures/g1-real-world.png)
...
![窗口大小与成功率](figures/window_size_ablation.png)
