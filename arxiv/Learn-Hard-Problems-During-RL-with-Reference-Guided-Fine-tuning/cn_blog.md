...
### 方法总览
![Figure 1](figures/approach_4.png)
...
![AIME24](figures/aime24_acc_comparison_main.png)
![AIME25](figures/aime25_acc_comparison_main.png)
![BeyondAIME](figures/beyond_aime_acc_comparison_main.png)
...
![AIME24 ReFT vs ReGFT](figures/aime24_acc_comparison_ReFT_ablation.png)
![AIME25 ReFT vs ReGFT](figures/aime25_acc_comparison_ReFT_ablation.png)
![BeyondAIME ReFT vs ReGFT](figures/beyond_aime_acc_comparison_ReFT_ablation.png)

> 图解：ReFT 在早期也有加速，但收敛后普遍被 ReGFT 超过；在 Beyond-AIME 上甚至可能不如 raw DAPO。这说明“只强化已有成功轨迹”不足以打开难题能力边界。

## 主结果三：直接 SFT 人类参考解不行
![AIME24 SFT ablation](figures/aime24_acc_sft_ablation.png)
![AIME25 SFT ablation](figures/aime25_acc_sft_ablation.png)
![BeyondAIME SFT ablation](figures/beyond_aime_acc_sft_ablation.png)
...
![AIME24 pass@k](figures/test_time_scaling_aime24.png)
![AIME25 pass@k](figures/test_time_scaling_aime25.png)
![BeyondAIME pass@k](figures/test_time_scaling_beyond-aime.png)
