• # LoRA 到底怎么记住东西的？揭秘大模型参数化记忆的幂律与相变
  ...
  ![Figure 2c](figures/fig_pred_vs_true.png)
  ...
  ![Figure 2d](figures/fig_heatmap_loss.png) ![Figure 2e](figures/fig_heatmap_acc.png)
