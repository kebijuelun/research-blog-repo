...
![Thinking Mode](figures/glm5_tr_thinking_mode_v2.png)
...
![ARC Results](figures/arc_clean.png)
...
## Search Agent 的上下文管理
![BrowseComp CM](figures/GLM5-BC-cm.png)
> 图解：keep-recent-k + discard-all 组合，在上下文预算下显著提升 BrowseComp 任务得分。

---

## Slide 生成：奖励分层 + 防 hack
![Reward Hacking](figures/ppt_reward_hacking.png)
