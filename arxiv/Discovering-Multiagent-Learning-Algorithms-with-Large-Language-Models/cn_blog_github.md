...
![Figure: CFR Train](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/Discovering-Multiagent-Learning-Algorithms-with-Large-Language-Models/figures/cfr_train.png)

> 图解：横轴是迭代轮数（通常到 1000），纵轴是 exploitability（对数尺度，越低越好）。训练集上，VAD-CFR 曲线整体下降更快，说明收敛效率更高。

![Figure: CFR Test](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/Discovering-Multiagent-Learning-Algorithms-with-Large-Language-Models/figures/cfr_test.png)

> 图解：测试集上，VAD-CFR 仍保持较低 exploitability，说明它并非只记住训练游戏的“过拟合技巧”，而是学到了可迁移的更新机制。

### PSRO 结果图（训练 + 测试）

![Figure: PSRO Train](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/Discovering-Multiagent-Learning-Algorithms-with-Large-Language-Models/figures/psro_train.png)

> 图解：横轴是 PSRO 外层迭代（文中关注到第 100 轮），纵轴是 exploitability（对数尺度）。SHOR-PSRO 在早中期下降更快，体现了混合 solver 的效率优势。

![Figure: PSRO Test](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/Discovering-Multiagent-Learning-Algorithms-with-Large-Language-Models/figures/psro_test.png)

> 图解：在更复杂的测试游戏中，静态 solver 更容易进入平台期；SHOR-PSRO 通过动态退火与训练/评估解耦，曲线通常更稳、更低。

### 全 11 游戏总览

![Figure: CFR All Games](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/Discovering-Multiagent-Learning-Algorithms-with-Large-Language-Models/figures/cfr_all_games.png)

> 图解：跨 11 个游戏的总体比较中，VAD-CFR 在绝大多数任务上达到或超过已有强基线，体现出较强广泛性。

![Figure: PSRO All Games](https://raw.githubusercontent.com/kebijuelun/research-blog-repo/main/arxiv/Discovering-Multiagent-Learning-Algorithms-with-Large-Language-Models/figures/psro_all_games.png)
