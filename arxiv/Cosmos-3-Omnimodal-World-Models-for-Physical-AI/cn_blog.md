...
![Cosmos 3 总览](figures/introduction/tikz_cosmos3_overview.png)
...
![Cosmos 3 平台定位](figures/introduction/tikz_cosmos_platform.png)
...
![统一动作表示](figures/model_architecture/action/tikz_action_representation.png)
...
![动作生成模式](figures/model_architecture/action/tikz_action_modes.png)
...
![MoT 架构](figures/model_architecture/tikz_mot_architecture.png)
...
![3D MRoPE 坐标分配](figures/model_architecture/tikz_mrope_coordinate_assignment.png)
...
![Reasoner 数据构成](figures/data/reasoner/tikz_reasoner_pretraining_category_mix.png)
...
![多视角动作打包](figures/data/action/multiview_droid_16164052.jpg)
...
![SDG-PhyxSim 样例](assets/sdg_phyxsim/wrecking_ball_5524_f046_rgb.jpg)
...
![SDG-DriveSim 场景](assets/sdg_drivesim/frame_collision.jpg)
...
![多分辨率序列打包与数据配比](figures/model_architecture/tikz_multiresolution_sequence_packing.png)
...
![Generator 数据课程](figures/data/tikz_data_curriculum.png)
...
![基础设施总览](figures/infrastructure/tikz_infra_overview.png)
...
![服务延迟](figures/infrastructure/serving/cosmos3_serving_latency_combined_1x3.png)
...
![T2I 样例](figures/results/sft_t2i/sft_t2i_demo.jpg)
...
![T2I 竞技场榜单](figures/results/sft_t2i/2026-05-28-Cosmos3-Super-Text2Image-Leaderboard.jpg)
...
![音视频对齐](figures/results/audio/av_align_no_reels.png)
...
![驾驶场景迁移](figures/results/transfer/avtransfer02.jpg)
...
![相机前向动力学](figures/results/action/camera_fd_figure.png)
...
![RoboArena 榜单](figures/results/action/roboarena_leaderboard_final.jpg)

> 图解：RoboArena 真实世界基准排行榜（2026-05-30），Cosmos3-Nano-Policy-DROID 位列第一。该基准允许任何拥有 DROID 平台的人在任意环境与任务上做双盲 A/B 对比，最终分数由成对偏好聚合而成。

![真实机器人部署](figures/results/action/snapshots_20260520_02_put_the_screwdriver_on_the_top_shelf_view_1_zoom_tlr10_spaced.jpg)
