...
![ARE 高层结构](assets/foundations/main-diagram.png)
...
![App 使用分布](assets/foundations/gaia2_app_usage_distribution.png)
...
![能力分类图](assets/foundations/gaia2_capability_table.png)
...
![验证器匹配示意](assets/verifier/verifier_matching_3.png)
...
![能力分布结果](assets/results/passat1_bar_detailed_100_scale.png)
...
![成本与时间对比](assets/results/passat1_vs_scenario_cost_and_time_per_scenario.png)
...
![性能驱动因素](assets/results/final_score_vs_toks_and_llm_calls.png)
...
![Time 结果](assets/results/gaia_time_bar.png)
![Time 逆缩放](assets/results/inverse_scaling_time.png)
...
![Agent2Agent 示例](assets/results/agent2agent_task_decomp_viz.png)

> 图解：左侧展示主 Agent 与子 Agent 的任务分解沟通，右侧显示协作可以降低工具调用错误率。

![Agent2Agent scaling](assets/results/final_pass_at_k_scaling_laws_with_a2a.png)
