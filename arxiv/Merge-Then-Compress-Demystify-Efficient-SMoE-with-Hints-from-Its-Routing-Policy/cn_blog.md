...
![Figure 4](Figs/intro-teaser.png)
...
## 补充实验：方法设计的有效性
### 1. 自适应合并比例优于固定比例
![Figure 5](Figs/grouping-results/expert-grouping-copa.png)
> 图解：不同任务下专家聚类结构不同，自适应合并可以更好匹配每层冗余程度。

### 2. 路由 logits 相似度最稳
![Figure 6](Figs/grouping-results/expert-grouping-squad.png)
...
![Figure 7](Figs/dominant-teaser.png)
