...
![Kimi K2.5 Main Results](figures/k25-main-result.png)  
...
![Vision-Text Joint Training Curves](figures/vision-joint.png)  
...
![Multi-Agent RL System](figures/multi-agent-rl-system.png)  
...
![Vision RL Curves](figures/k25_visionzerorl_curves.png)  
...
### Agent Swarm 架构
![PARL Orchestration](figures/multi-agent-rl-system.png)  
...
### 效率收益
![Agent Swarm Efficiency](figures/agent_swarm_efficiency.png)  
...
![Token Efficient RL Radar](figures/te-k2-thinking-radar.png)  
