...
![Figure 1](figures/pareto_only.png)
...
![Agent Harness](figures/aroll_karl_figure.png)
...
![Stage1](figures/stage_1_agentic_synthesis.png)
...
![Stage2](figures/stage_2_agentic_synthesis.png)
...
![SFT vs RL](figures/sft_vs_rl.png)
...
![Traj by pass](figures/traj_length_flow_by_pass.png)

> 图解：按 Pass@16 分类看，训练后各类样本轨迹整体缩短，尤其已可解样本缩短明显，说明模型减少了无效搜索。

### 10.2 搜索多样性变高

![Search diversity](figures/bcp_trec_search_diversity.png)

> 图解：累计独立文档数随步数增长更快，说明 query 合成更丰富，重复检索更少。

### 10.3 搜全证据后的“浪费搜索”变少

![Search efficiency](figures/bcp_stacked_searches_clean.png)

> 图解：下部浅色是拿齐关键证据所需搜索，上部深色是拿齐后额外搜索。RL 迭代后，上部显著下降，直接转化为更低成本与更短延迟。

### 10.4 行为模式从“搜不完”转向“探索后提交”

![Category pie](figures/category_piecharts.png)
...
![Compression](figures/compression.png)
