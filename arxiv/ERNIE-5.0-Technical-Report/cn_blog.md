...
![Figure 1](latex_files/figures/arch.png)
...
![Figure 2](latex_files/figures/first_layer_experts_distribution.png)
![Figure 3](latex_files/figures/mid_layer_experts_distribution.png)
![Figure 4](latex_files/figures/last_layer_experts_distribution.png)
> 图解：不同层专家激活分布。可以看到非均匀激活，专家在模态上自然分化。

![Figure 5](latex_files/figures/first_layer_iou_heatmap.png)
![Figure 6](latex_files/figures/mid_layer_iou_heatmap.png)
![Figure 7](latex_files/figures/last_layer_iou_heatmap.png)
> 图解：不同模态 top-25% 激活专家的 IoU 重叠。深层跨模态重叠增强，表明语义逐步统一。

![Figure 8](latex_files/figures/moe_experts_normalized_entropy.png)
> 图解：各层专家负载均衡度（NE）。
...
![Figure 9](latex_files/figures/elastic_training_3.png)
...
![Figure 10](latex_files/figures/arch_vision.png)
...
![Figure 11](latex_files/figures/arch_audio.png)
...
![Figure 12](latex_files/figures/urb.png)
> 图解：U-RB 机制，保持数据顺序并避免长尾拖慢训练。

![Figure 13](latex_files/figures/mis_acc.png)
![Figure 14](latex_files/figures/mis_entropy.png)
> 图解：MISC 稳定 RL 训练，避免早期熵崩塌。

![Figure 15](latex_files/figures/hint_based_rl.png)
